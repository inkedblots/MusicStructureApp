...
public class MichaeljacksonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Song list
        songs.add(new Song("Billie Jean", "Thriller", R.drawable.ic_mthriller,
                R.raw.mj_billiejean));
        songs.add(new Song("Beat It", "Thriller", R.drawable.ic_mthriller,
                R.raw.mj_beatit));
        songs.add(new Song("Thriller", "Thriller", R.drawable.ic_mthriller, R.raw.mj_thriller));
        songs.add(new Song("PYT", "Thriller", R.drawable.ic_mthriller, R.raw.mj_pyt));
        songs.add(new Song("Don\'t Stop \'til You Get Enough", "Off the Wall",
                R.drawable.ic_mwall, R.raw.mj_dontstop));
        ...
        SongAdapter adapter = new SongAdapter(this, songs, R.color.artist_michaelJackson);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(MichaeljacksonActivity.this, song.getAudioResourceId());
