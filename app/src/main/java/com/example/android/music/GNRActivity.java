...
public class GNRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Song list
        songs.add(new Song("Sweet Child \'O Mine", "Appetite for Destruction", R.drawable.ic_gappetite, R.raw.gnr_sweetchild));
        songs.add(new Song("Welcome to the Jungle", "Appetite for Destruction", R.drawable.ic_gappetite, R.raw.gnr_welcometothejungle));
        songs.add(new Song("Paradise City", "Appetite for Destruction", R.drawable.ic_gappetite, R.raw.gnr_paradisecity));
        songs.add(new Song("November Rain", "Use Your Illusion", R.drawable.ic_gillusion, R.raw.gnr_novemberrain));
        songs.add(new Song("Shadow of Your Love", "Shadow of Your Love (single)", R.drawable.ic_gshadow, R.raw.gnr_shadow));
        ...
        SongAdapter adapter = new SongAdapter(this, songs, R.color.artist_gnr);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(GNRActivity.this, song.getAudioResourceId());
