...
public class DavidbowieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Song list
        songs.add(new Song("Starman", "The Rise and Fall of \nZiggy Stardust", R.drawable.ic_dstarman, R.raw.bowie_starman));
        songs.add(new Song("Heroes", "Heroes", R.drawable.ic_dbheroes, R.raw.bowie_heroes));
        songs.add(new Song("Life on Mars?", "Hunky Dory", R.drawable.ic_dhunky, R.raw.bowie_lifeonmars));
        songs.add(new Song("Space Oddity", "Davie Bowie", R.drawable.ic_dbowie, R.raw.bowie_spaceoddity));
        songs.add(new Song("Moonage Daydream",
                "The Rise and Fall of \nZiggy Stardust", R.drawable.ic_dmoon, R.raw.bowie_moonage));
        ...
        SongAdapter adapter = new SongAdapter(this, songs, R.color.artist_davidBowie);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(DavidbowieActivity.this, song.getAudioResourceId());
