...
public class MadonnaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Song list
        songs.add(new Song("Like a Prayer", "Like a Prayer", R.drawable.ic_mprayer, R.raw.maonna_prayer));
        songs.add(new Song("Hung up", "Confessions on a Dance Floor", R.drawable.ic_mconfessions, R.raw.madonna_hungup));
        songs.add(new Song("Material Girl", "Like a Virgin", R.drawable.ic_mvirgin, R.raw.madonna_materialgirl));
        songs.add(new Song("Like a Virgin", "Like a Virgin", R.drawable.ic_mvirgin, R.raw.madonna_virgin));
        songs.add(new Song("La Isla Bonita", "La Isla Bonita (single)", R.drawable.ic_mbonita, R.raw.madonna_bonita));
        ...
        SongAdapter adapter = new SongAdapter(this, songs, R.color.artist_madonna);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(MadonnaActivity.this, song.getAudioResourceId());
